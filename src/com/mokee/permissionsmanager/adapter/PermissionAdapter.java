...
public class PermissionAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = layoutInflater.inflate(R.layout.mk_per_list_item,
					null);
			wrapperView = new WrapperView();
			wrapperView.appName_textView = (TextView) convertView.findViewById(R.item.permissionName);
			wrapperView.permissionStatus_switch = (Switch) convertView.findViewById(R.item.permissionStatus);
			wrapperView.permissionInfo_textView = (TextView) convertView.findViewById(R.item.permissionInfo);
		...
		if(isRevoked)
		{
			wrapperView.appName_textView.setPaintFlags(wrapperView.appName_textView.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
